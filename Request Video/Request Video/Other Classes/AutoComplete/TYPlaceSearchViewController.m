...
- (void)searchAutocompleteLocationsWithSubstring {
    ...
    [[TYGooglePlacesApiClient sharedInstance] retrieveGooglePlaceInformation:_substring ForLocation:_location withCompletion:^(BOOL isSuccess, NSError *error) {
